# How-to-include-custom-header-using-axml-file-in-schedule-Xamarin.Android

This example demonstrates how to include custom header using axml file in schedule Xamarin.Android.
